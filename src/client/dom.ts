...
const ICONS: Record<string, string> = {
  ...
  folder: '<path d="M3 6a2 2 0 012-2h5l2 2h7a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V6z"/>',
  folderOpen: '<path d="M3 8V6a2 2 0 012-2h5l2 2h7a2 2 0 012 2v2"/><path d="M3 9h18l-2 9a2 2 0 01-2 2H6a2 2 0 01-2-2L3 9z"/>',
  fileText: '<path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9z"/><polyline points="13 2 13 9 20 9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="15" y2="17"/>',
  image: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/>',
  code: '<polyline points="8 9 4 12 8 15"/><polyline points="16 9 20 12 16 15"/><line x1="14" y1="5" x2="10" y2="19"/>',
  presentation: '<rect x="3" y="3" width="18" height="14" rx="2"/><path d="M8 21l4-4 4 4M8 8h8M8 12h5"/>',
  board: '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 8h3v3H8zM14 7h3v6h-3zM7 15h10"/>',
