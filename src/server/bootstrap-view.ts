...
export function channelMetaView(channel: Row, viewer: Row | null | undefined, detailed: boolean, rules: ViewerRules): Record<string, unknown> {
  ...
  return {
    ...
    session_mode: Boolean(channel.session_mode),
    session_sort: channel.session_sort === "active" ? "active" : "default",
    session_density: ["comfy", "compact"].includes(String(channel.session_density)) ? channel.session_density : "default",
