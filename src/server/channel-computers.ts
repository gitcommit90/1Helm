...
export const DEFAULT_CHANNEL_IMAGE = process.env.HELM_CHANNEL_MACHINE_IMAGE || "local/1helm-channel-machine:1.1.15";
...
export async function reconcileChannelComputers(): Promise<{ checked: number; errors: number }> {
